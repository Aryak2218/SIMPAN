...
<div class="content-wrapper">
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Edit Banner Artikel</h1>
        </div>
        <div class="col-sm-6">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select name="artikel_id" class="form-control">
                    @foreach ($artikels as $artikel)
                      <option value="{{ $artikel->id }}" {{ $banner->artikel_id == $artikel->id ? 'selected' : '' }}>
                        {{ $artikel->judul }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="judul_teks" class="form-control" value="{{ old('judul_teks', $banner->judul_teks) }}">
                ...
                <div class="form-group">
                  ...
                  <textarea name="subjudul_teks" class="form-control" rows="3">{{ old('subjudul_teks', $banner->subjudul_teks) }}</textarea>
                ...
                <div class="form-group">
                  ...
                  @if ($banner->gambar)
                    <img src="{{ asset('storage/' . $banner->gambar) }}" width="150">
                  @endif
                ...
                <div class="form-group">
                  ...
                  <select name="aktif" class="form-control">
                    <option value="1" {{ $banner->aktif == 1 ? 'selected' : '' }}>Aktif</option>
                    <option value="0" {{ $banner->aktif == 0 ? 'selected' : '' }}>Tidak Aktif</option>
                  </select>
